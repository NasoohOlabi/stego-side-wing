#!/usr/bin/env python3
"""Watchdog for a 100-success LUCID sample campaign used for ZLG comparison.
...
_CAMPAIGN = "LUCID_context_weighted_v2_balanced_100"
_TARGET = 100
...
def _write_processes(
    *,
    ...
    lines = [
        ...
        f"Last checked: {_now()}",
        "",
        "## LUCID 100-sample campaign (ZLG comparison)",
        "",
        "| Field | Value |",
        "| --- | --- |",
        f"| Status | **{status}** |",
    ...
    daemon_pid_path = _RUNS / "watch_lucid_100_samples.daemon.pid"
    daemon_pid = (
    ...
    lines.extend(
        [
            ...
            "## Watchdog",
            "",
            f"- Script: `stego-side-wing/scripts/watch_lucid_100_samples.py`",
