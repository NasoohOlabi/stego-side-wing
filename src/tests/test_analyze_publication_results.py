...
def test_report_keeps_failures_in_attempt_denominator() -> None:
    module = _load_module()
    rows = [
        {"post_id": "p1", "method": "our_method", "accepted": True, "decode_ok": True, "payload_bits_encoded": 64, "word_count": 32, "latency_ms": 10},
        {"post_id": "p2", "method": "our_method", "accepted": False, "decode_ok": False, "reason": "generation", "latency_ms": 5},
        {"post_id": "p1", "method": "official_zgls", "accepted": True, "decode_ok": True, "payload_bits_encoded": 64, "word_count": 16, "latency_ms": 20},
        {"post_id": "p2", "method": "official_zgls", "accepted": True, "decode_ok": True, "payload_bits_encoded": 64, "word_count": 16, "latency_ms": 20},
    ]
